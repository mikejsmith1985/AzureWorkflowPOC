...
/// <param name="Endpoint">Optional base endpoint for OpenAI-compatible providers (Azure OpenAI, Ollama,
/// LM Studio); null uses the provider's default. Ignored by providers that do not support it.</param>
    ...
    string? Endpoint = null)
{
    ...
    /// <summary>An alternative built-in provider id (spec-019 T043) — proves the seam is provider-neutral.</summary>
